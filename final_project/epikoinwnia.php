...
<div id="logo"> <a href="index.php"><img src="rsun.gif" width="200" height="200" alt="hlio"/></a> </div>
...
<ul>
  ...
  <li><a class="active" href="epikoinwnia.php">Επικοινωνία</a></li>
</ul>
</nav>
...
Για να δημοσιεύσετε ή για οποιαδήποτε άλλη επικοινωνία υπάρχει ο λογαριασμός ηλεκτρονικού ταχυδρομείου: <h2 style="color: #660000">chrispar[at]ee.duth.gr</h2>
</div>
</section>
