...
<ul>
  ...
  <li><a class="active" href="video.php">Βίντεο</a></li>
...
<section>
<article id="vid">
      <h1 align="center" style="color: #660000"> Javaspa ~ Νομενκλατούρα</h1>

                    <video width="300" controls>
                    <source src="Javaspa_.mp4" type="video/mp4">
